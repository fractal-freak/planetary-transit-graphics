...
export default function CollapsibleSection({ id, title, icon, headerExtra, children, defaultOpen = true }) {
  ...
  return (
    <section className={`${styles.section} ${open ? styles.sectionOpen : styles.sectionClosed}`}>
      <div className={styles.sectionHeader}>
        ...
        {headerExtra && <span className={styles.sectionHeaderExtra}>{headerExtra}</span>}
      </div>
